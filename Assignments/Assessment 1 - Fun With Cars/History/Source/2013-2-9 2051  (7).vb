...
Module Module1
    ...
    Dim currentDatabase As String = "default"

    ' Menu colours
    Dim cUser, cOption, cDeco, cBracket, cDesc, cHeading, cInput, cError, cInfo, cInstruction, cCar, cValue, cNum As ConsoleColor

    Sub Main()
        Dim carObject As New CarStructure
        Debug.WriteLine(ArgsInStr("1 Car object needs {0} bytes", {CStr(System.Runtime.InteropServices.Marshal.SizeOf(carObject))}))
...
#Region "Car Operations"
    ...
    Private Sub SaveCarToFile(ByVal theCar As Car)
        Dim writer As New StreamWriter("Databases\cars.txt", True)
    ...
    Private Sub SaveListToFile()
        ...
        My.Computer.FileSystem.DeleteFile("Databases\cars.txt")
        ...
        Dim writer As New StreamWriter("Databases\cars.txt", False)
    ...
    Private Sub LoadCarsfromFile()
        CarList.Clear()
        If My.Computer.FileSystem.FileExists("Databases\cars.txt") Then
            Dim reader As New StreamReader("Databases\cars.txt")
...
#Region "Number Functions"
    ...
    ''' <summary>
    ''' Returns the specified valu of all cars in an array
    ''' </summary>
