...
Module Module1
    ...
    Private Sub EditCar()
        ...
        CarList.Item(realIndex).Brand = NewVirtualString("Brand: ", CarList.Item(realIndex).Brand, ConsoleColor.Green, ConsoleColor.Red, ConsoleColor.Yellow)
        CarList.Item(realIndex).Make = NewVirtualString("Make: ", CarList.Item(realIndex).Make, ConsoleColor.Green, ConsoleColor.Red, ConsoleColor.Yellow)
        CarList.Item(realIndex).Model = NewVirtualString("Model: ", CarList.Item(realIndex).Model, ConsoleColor.Green, ConsoleColor.Red, ConsoleColor.Yellow)
        CarList.Item(realIndex).Year = CInt(NewVirtualString("Year: ", CarList.Item(realIndex).Year, ConsoleColor.Green, ConsoleColor.Red, ConsoleColor.Yellow))
        CarList.Item(realIndex).BaseCost = CInt(NewVirtualString("Base Cost: ", CarList.Item(realIndex).BaseCost, ConsoleColor.Green, ConsoleColor.Red, ConsoleColor.Yellow))
        CarList.Item(realIndex).Markup = CSng(NewVirtualString("Dealer Markup percentage (i.e. 50 for 50%): ", CarList.Item(realIndex).Markup, ConsoleColor.Green, ConsoleColor.Red, ConsoleColor.Yellow))
    ...
    Private Function NewVirtualString(ByVal solidWord As String, ByVal content As Integer, _
                                      Optional ByVal solidColor As ConsoleColor = ConsoleColor.DarkGray, _
                                      Optional ByVal contentColor As ConsoleColor = ConsoleColor.DarkGray, _
                                      Optional ByVal afterColor As ConsoleColor = ConsoleColor.DarkGray, _
                                      Optional ByVal resetColor As Boolean = True) As String
    ...
    Private Function NewVirtualString(ByVal solidWord As String, ByVal content As Single, _
                                     Optional ByVal solidColor As ConsoleColor = ConsoleColor.DarkGray, _
                                     Optional ByVal contentColor As ConsoleColor = ConsoleColor.DarkGray, _
                                     Optional ByVal afterColor As ConsoleColor = ConsoleColor.DarkGray, _
                                     Optional ByVal resetColor As Boolean = True) As String
