...
#Region "Screens"
    Private Sub DisplayMenu()
        Console.Clear()
        cWrite("Welcome to Fun With Cars. (Evert Geldenhuys)", cHeading)
        Console.WriteLine()
        cWrite("Select your option from the below menu:", cInstruction)
        cWriteArray("    (|A|) Add a car", {cMenu, cOption, cMenu})
        cWriteArray("    (|B|) Edit a car", {cMenu, cOption, cMenu})
        cWriteArray("    (|C|) View Car Details", {cMenu, cOption, cMenu})
        cWriteArray("    (|D|) Display car statistics", {cMenu, cOption, cMenu})
        cWriteArray("    (|E|) Remove a car", {cMenu, cOption, cMenu})
        cWriteArray("    (|Q|) Quit", {cMenu, cOption, cMenu})
        cWrite("Selection: ", cInput, False, cUser)
