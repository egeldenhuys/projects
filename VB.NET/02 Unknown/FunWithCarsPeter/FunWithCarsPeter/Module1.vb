Module Module1
    ...
    Sub AddCar()
        ...
        If car_count < 10 Then
            ...
            Console.WriteLine()
            Console.Write("      Year: ")
            cars(car_count).year = Console.ReadLine
            Console.WriteLine()
            Console.Write("      Base Cost: ")
            cars(car_count).basecost = Console.ReadLine
            Console.WriteLine()
            Console.Write("      Dealer Markup Percentage <i.e. 50 for 50%): ")
            cars(car_count).markup = Console.ReadLine
            Console.WriteLine()
    ...
    Sub LoadCar()
        ...
        If IO.File.Exists("cars.txt") Then
            ...
            While Not EOF(1)
                ...
                cars(car_count).year = LineInput(1)
                cars(car_count).basecost = LineInput(1)
                cars(car_count).markup = LineInput(1)
