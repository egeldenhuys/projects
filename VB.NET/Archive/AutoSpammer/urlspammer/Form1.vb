...
Public Class Form1
    ...
    Private Function CreateClients(amount As Integer, userAgent As String, referer As String) As WebClient()
        ...
        For i As Integer = 0 To amount - 1
            ...
            result(i).Headers.Add("Contact-Email", "ForestPankey@Gmail.Com")

            If txtProx.Text <> "0" Then
                result(i).Proxy = prox
            End If
    ...
    Private Sub btnTest_Click(sender As System.Object, e As System.EventArgs) Handles btnTest.Click
        ...
        wc.Headers.Add("Contact-Email", "ForestPankey@Gmail.Com")
        wc.Headers.Add("SPAM", "X5O!P%@AP[4\PZX54(P^)7CC)7}$EICAR-STANDARD-ANTIVIRUS-TEST-FILE!$H+H*")
        wc.Headers.Add("SPAM2", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA" & _
